...
def launch_instances(ami, instance_types, key):
    ...
    for instance in instance_types:
        cmd = 'aws ec2 run-instances {}'.format(get_flags(ami, instance, key))
...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', '--version', type=str, required=True, help='software version of OpenALPR')
